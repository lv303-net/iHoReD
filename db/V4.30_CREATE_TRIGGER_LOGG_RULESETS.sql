...
WHERE TABLE_NAME = 'RULESETS' AND TABLE_SCHEMA='dbo'
...
PRINT @NEW;
PRINT @FIRST_COLUMN;
INSERT INTO LOGGER(OLD, NEW, COLUMN_NAME, TABLE_NAME, DATE_OF_UPDATE, USER_ID, ROW_ID) VALUES(@OLD, @NEW, @COL_NAME, 'RULESETS', GETDATE(), @USER, @ROW_ID);
END 
  END
