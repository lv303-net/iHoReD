IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name ='NON_ACTIVE_DISEASES_FOR_CATEGORY.sql')
BEGIN
...
BEGIN
    ...
    OR (ID_DISEASE IS NULL OR PATIENT_DISEASES.END_DATETIME<=GETDATE())) AND SUBDISEASES.DISEASEID=@DISEASEID;
