...
AS
BEGIN
	IF((SELECT COUNT(ID_ALLERGY) FROM ALLERGIES) != 0)
	BEGIN
		INSERT INTO ALLERGIES(ID_ALLERGY,ALLERGY_NAME,ALLERGY_DESCRIPTION) VALUES ((SELECT MAX(ID_ALLERGY) + 1 FROM ALLERGIES), @ALLERGY_NAME, @ALLERGY_DESCRIPTIONS)
	END;
	ELSE
